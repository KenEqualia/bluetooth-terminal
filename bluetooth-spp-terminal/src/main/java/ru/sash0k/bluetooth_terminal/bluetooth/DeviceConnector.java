...
public class DeviceConnector {
    ...
    /**
     * Getting the status or state of the device
     */
    ...
    /**
     * Thread to connect to a bluetooth device
     */
    // ==========================================================================
    private class ConnectThread extends Thread {
         ...
         * When the connection is successful it transfers control to another thread
         */
        public void run() {
    ...
    /**
     * Thread to communicate with the bluetooth device
     */
    // ==========================================================================
    private class ConnectedThread extends Thread {
        ...
        /**
         * The basic working method - it waits for commands from the incoming stream
         */
        public void run() {
            ...
            while (true) {
                try {
                    // I read out the incoming data from the stream and collected in a response line
                    bytes = mmInStream.read(buffer);
                    String readed = new String(buffer, 0, bytes);
                    readMessage.append(readed);

                    //mark the end of the team - returns an answer to the main stream
                    if (readed.contains("\n")) {
